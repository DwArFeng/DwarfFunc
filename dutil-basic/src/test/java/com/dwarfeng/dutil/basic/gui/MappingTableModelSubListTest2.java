...
public class MappingTableModelSubListTest2 {
    ...
    public void setUp() {
        ...
        tableModel = new MappingTableModel<>(Employee.class, EmployeeMappingInfos.class, employees);
    ...
    public final void testHashCode() {
        ...
        list.addAll(Arrays.asList(EMPLOYEE_B, EMPLOYEE_C, EMPLOYEE_D));
    ...
    public final void testRetainAll() {
        ...
        assertTrue(subList.retainAll(Collections.singletonList(EMPLOYEE_B)));
        assertEquals(1, subList.size());
        assertEquals(3, tableModel.size());
        assertEquals(TableModelEvent.DELETE, tableModelListener.eventList.get(0).getType());
    }
