...
public interface MapObserver<K, V> extends Observer {
    ...
    /**
     * 通知指定的键映射的元素被改变。
     * <p> 注意，当调用 {@link MapModel#put(Object, Object)} 方法时，如果模型中已经存在指定的键，
     * 则模型会调用该方法进行通知，而不是调用 {@link #firePut(Object, Object)}方法进行通知。
     *
     * @param key      指定的键。
    ...
    /**
     * 通知模型中的内容被清除。
     * <p> 该方法是为了提高效率而定义的，当模型执行 {@link MapModel#clear()} 方法的时候，
