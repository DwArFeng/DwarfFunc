...
public class DelegateI18nHandlerTest {
	...
	public void testSetCurrentLocale() {
		...
		assertEquals(null, observer.changedLocaleOldValue.get(0));
	...
	public void testRemoveKey() {
		...
		assertEquals(null, handler.getCurrentLocale());
		assertEquals(null, observer.changedLocaleNewValue.get(1));
		assertEquals("你好", handler.getCurrentI18n().getString("hello"));
	}
	...
	public void testRemoveKeyNull() {
		...
		assertEquals(null, observer.changedLocaleOldValue.get(0));
		assertEquals(null, observer.changedLocaleNewValue.get(0));
		assertEquals(null, handler.getCurrentI18n());
	}
